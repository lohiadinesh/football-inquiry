package com.company.footballinquiry.service;
...
import com.company.footballinquiry.client.TeamStandingRestClient;
...
public class TeamStandingService {
	...
	private static Logger log = LoggerFactory.getLogger(TeamStandingService.class);
